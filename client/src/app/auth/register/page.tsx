        ...
        />
          ...
          <div className="lg:w-1/2 p-12 flex flex-col justify-center">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-500">Please Register to your account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full h-12 cursor-pointer text-white font-semibold rounded-lg">
